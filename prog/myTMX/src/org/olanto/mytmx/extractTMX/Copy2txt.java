...
public class Copy2txt {
    ...
    public static void main(String[] args) {
        ...
        pivotLang = "EN";
        sourceTMX = "C:" + "/MYTMX/corpus/BLCK/";
        targetMFLF = "C:" + "/MYTMX/corpus/txt/";
    ...
    static void process(String corpusName, String pivotLang) {
        ...
        try {
            ...
            OutputStreamWriter SOmflf = new OutputStreamWriter(new FileOutputStream(targetMFLF + "/" + langSO + "/" + corpusName + ".mono"), "UTF-8");
            OutputStreamWriter TAmflf = new OutputStreamWriter(new FileOutputStream(targetMFLF + "/" + langTA + "/" + corpusName + ".mono"), "UTF-8");
